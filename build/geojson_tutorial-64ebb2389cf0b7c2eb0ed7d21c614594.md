...
\
7\. Click "Install & Authorize". It is important to select "All repositories" because git-clerk will create a fork from the existing data catalog.
...
\
17\. Type the title you want to give your dataset, e.g. "GeoJSON Example".
...
\
19\. Type the identifier you want to appear in the URL when selected, e.g. "geojson_example1".
...
\
27\. Add "GeoJSON source" as the Name (this will be autofilled in the future).
...
\
28\. Add the URL of the pre-created eodash JSON style file. See also <https://eodash.org/styling.html> for more information.
...
\
30\. The GeoJSON source assigns files to times. Click the plus button to create a new time entry.
...
\
35\. Disable optional parameters by unchecking them (this step will not be needed in the future; they will be disabled automatically).
...
\
42\. Close the Selection panel by clicking "✕" (you can also use the fullscreen button to change from mobile view).
...
\
43\. Congratulations! You should see your data styled and displayed in the area you selected.
